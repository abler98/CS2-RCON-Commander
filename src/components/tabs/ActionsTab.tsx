...
export default function ActionsTab() {
  ...
  const { isLoadingCvars, cvars, fetchCvars } = useCvarsContext();
          ...
          <div className="bg-cs-bg-panel border border-cs-border rounded-lg p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                >
                  <div
                    className={`w-4 h-4 bg-white rounded-full transition-transform ${friendlyFire ? 'translate-x-6' : 'translate-x-0'}`}
                  />
                </button>
              </div>
              <div className="pt-4 space-y-2">
                <label className="text-[10px] uppercase text-cs-muted font-bold block">
                  Quick Restart Schedule (Seconds)
                </label>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      value={ctName}
                      onKeyDown={(e) =>
                        e.key === 'Enter' && executeAction('teamname', ctName, 'ct')
                      }
        ...
        <div className="space-y-6">
          <div className="bg-cs-bg-panel border border-cs-border rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label
                  htmlFor="bot-quota-mode"
                  className="text-[10px] uppercase text-cs-muted font-bold"
                >
                  Quota Mode
                </label>
          ...
          <div className="bg-cs-bg-panel border border-cs-border rounded-lg p-6">
            ...
            <div className="space-y-4">
              <p className="text-[10px] text-cs-muted italic">
                Transmit a global text broadcast to all active session participants via RCON shell.
              </p>
              <div className="flex gap-2">
                <input
