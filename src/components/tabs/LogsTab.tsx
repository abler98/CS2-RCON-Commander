...
import { ChevronDown, Loader2, AlertTriangle, Power, PowerOff, ScrollText, Trash2, Pause, Play, Copy, Check } from 'lucide-react';
...
export default function LogsTab() {
  const { isConnected, isExecuting, logSignature, logServerAddr, executeCommand, runSilentCommand } = useRconContext();
  const {
    logs,
    sseStatus,
    logsPaused,
    ...
    copyIngestCommand,
  } = useLogs({ isConnected, isExecuting, logSignature, logServerAddr, executeCommand, runSilentCommand });
